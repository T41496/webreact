...
const WalletTipAlertModal = (props) => {
  ...
  return (
    <>
      <Modal
        ...
        size="md"
        centered
        show={props.walletTipAlert}
        onHide={props.closeWalletTipAlertModal}
      >
        <Form>
          ...
          <Modal.Footer>
            ...
            <Button type="button" className="btn btn-danger" data-dismiss="modal" onClick={props.closeWalletTipAlertModal} style={{ "height": "45px"}}>No</Button>
          </Modal.Footer>
        </Form>
      </Modal>
    </>
...
export default connect(null, mapDispatchToProps)(withNamespaces()(WalletTipAlertModal));
